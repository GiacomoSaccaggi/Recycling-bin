...
\begin{figure}[H]
	\center
	\includegraphics[width=200px]{CONFMATRIX.png}
	\caption{Matrice di confuione per problema di classificazione bivariato}
\end{figure}

Alcune misure di sintesi sono relative alle classi i-esime ($i=\{Carta, Indifferenziata, Plastica, Vetro \}$)
...
$$Precision= \frac{\mbox{True Positive}_i}{\mbox{Support}_i}$$

Il ``Recall" è il valore percentuale di quante previsioni si rivelano giuste rispetto al totale:

$$Recall= \frac{\mbox{True Positive}_i}{\mbox{Prediction}_i}$$
...
\begin{itemize}
	...
	\item Il parametro $K$ può essere scelto a priori in modo arbitrario oppure attraverso tecniche di validazione come Cross Validation.
\end{itemize}
