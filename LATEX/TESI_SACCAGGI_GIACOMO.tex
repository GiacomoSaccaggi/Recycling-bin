...
Analisi descrittiva dei dati: Tabella di statistiche per categoria di rifiuto e grafico con pairs


Per quanto riguarda i dati non strutturati si sono raccolte le immagini relative alle differenti tipologie di rifiuti con i tre metodi esposti in precedenza. Per quanto riguarda la prima metodologia, il Web Scraping, si sono raccolte 41042 immagini divise in 129 categorie. Con il Chatbot di Telegram sono state ricevute *num* foto relative alle tre categorie principali di rifiuti: Plastica, Carta e Vetro. Infine, attraverso il cestino, è stato possibile raccogliere, oltre ai dati strutturati spiegati in precedenza anche *num* immagini così da essere in grado di analizzare congiuntamente il problema da due punti di vista differenti.

Immagini Web Scraping:
...
tabella con numero di immagini per ogni categoria e per ogni metodo
