...
In alcuni ambiti con molte informazione circa la variabile di studio spesso viene utilizzato un modello di Stacking a più di due livelli, in questi casi occorre estendere la metodologia proposta reiterandola per il numero dei livelli.
